...
const timeII = [251300, 251330, 251342, 251357, 251410, 251430, 251446, 251500, 251517, 251600, 261300, 261330, 261343, 261356, 261405, 261423, 261428, 261444, 261459, 261520, Infinity];
const list = ['CK', 'CK',
  'B1', 'I1',
  'B2', 'I2',
  'B3', 'I3',
...
const list3 = ['開幕式', '開幕式',
  ...
  '自噬作用、 尿素循環參與在降血脂藥物誘導之防護作用', '臺灣地區全球暖化與極端天氣之關聯',
  //'中場休息', '中場休息',
